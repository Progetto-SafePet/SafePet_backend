...
public class TerapiaRequestDTO {
    ...
    public TerapiaRequestDTO(String nome, Long petId, String formaFarmaceutica, String dosaggio, String posologia,
                             String viaDiSomministrazione, String durata, String frequenza, String motivo) {
        this.nome = nome;
        this.petId = petId;
