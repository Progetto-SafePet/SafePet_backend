...
class GestionePazienteServiceImplAggiungiPazienteTest {
    ...
    /**
     * * ===========================
     * Test Case ID: TC_aggiungiPaziente_9
     * Test Frame: AU2, RU2, PE2, LC2, US2, SC2, AS2
     * Obiettivo:
     * Verificare che il sistema gestisca correttamente il caso di fallimento estremo fallendo al primo controllo
     * <p>
     * Parametri di input:
     * petId: 99
     * linkingCode: "INVALIDCODE"
     * ===========================
     */
    @Test
    @DisplayName("TF9: Fallimento - Priorità Utente non autenticato (AU2)")
    void TC_aggiungiPaziente_9() {
        // Arrange
        PazienteRequestDTO dto = new PazienteRequestDTO("INVALIDCODE");
        authContextMock.when(AuthContext::getCurrentUser).thenReturn(null);
    ...
    /**
     * * ===========================
     * Test Case ID: TC_aggiungiPaziente_10
     * Test Frame: AU1, RU1, PE1, LC1, US2, SC2, AS1
     * Obiettivo:
     * Verificare la priorità degli errori quando il codice è usato  e scaduto, in un contesto altrimenti valido.
     * <p>
     * Parametri di input:
     * petId: 1
     * linkingCode: "XYZ123"
     ...
     */
    @Test
    @DisplayName("TF10: Fallimento - Linking Code già utilizzato (US2)")
    void TC_aggiungiPaziente_10() {
        // Arrange
        PazienteRequestDTO dto = new PazienteRequestDTO(LINKING_CODE_VALIDO);
    ...
    /**
     * * ===========================
     * Test Case ID: TC_aggiungiPaziente_11
     * Test Frame: AU1, RU1, PE1, LC2, US2, SC1, AS1
     * Obiettivo:
     * Verificare che il sistema fallisca correttamente per codice inesistente anche se le condizioni di utilizzo sono errate.
     * <p>
     * Parametri di input:
     * petId: 1
     * linkingCode: "XYZ999"
     ...
     */
    @Test
    @DisplayName("TF11: Fallimento - Linking Code non esiste (LC2)")
    void TC_aggiungiPaziente_11() {
        // Arrange
        final String NON_EXISTING_CODE = "XYZ999";
        PazienteRequestDTO dto = new PazienteRequestDTO(NON_EXISTING_CODE);
